...
$dadosXls .= "          <tr>";
    ...
    $dadosXls .= "          <th>Fecha Solicitud</th>";
    $dadosXls .= "          <th>Fecha Atencion</th>";
    $dadosXls .= "          <th>Fecha Inicio</th>";
    $dadosXls .= "          <th>Fecha Entrega</th>";
    $dadosXls .= "          <th>Tiempo Actividad</th>";
    $dadosXls .= "          <th>Tiempo Improductivo</th>";
    $dadosXls .= "          <th>Recporte Cliente</th>";
    ...
    $result = $pdo->select("SELECT T2.razon, T3.descripcion, T4.nombre, T1.ordenTrabajo, T1.autorizado, T1.horometro, T1.fechasolicitud, 
...
WHERE razon = '$usuario';");
    ...
    foreach($result as $res){
        ...
        $dadosXls .= "          <td>".$res['fechasolicitud']."</td>";
        $dadosXls .= "          <td>".$res['fechaatencion']."</td>";
        $dadosXls .= "          <td>".$res['fechainicio']."</td>";
        $dadosXls .= "          <td>".$res['fechaentrega']."</td>";
        $dadosXls .= "          <td>".$res['tiempoatencion']."</td>";
        $dadosXls .= "          <td>".$res['tiempoimpro']."</td>";
        $dadosXls .= "          <td>".$res['reporcliente']."</td>";
