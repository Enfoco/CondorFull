...
<h3>Consulta Mantenimiento Preventivo Por Equipo</h3>
    ...
    <?php
                  ...
                  if(empty($buscar))
            {
                echo "No se ha ingresado una cadena a buscar";
                        ...
                        $con=mysql_connect("localhost","u746668508_condo","Elguru47");
                        $sql = "SELECT * FROM equipo WHERE usuario_id = '$buscar'";
                        mysql_select_db("u746668508_condo", $con); 
...
?>
          ...
          <p><b><a href="reciboPreven.php?id=<?php echo $row['id'];?>"><?php echo $row['descripcion']; ?></a></b></p>
<?php
