...
include "../../../../model/db.php";
 ...
 $sql = $PDO->prepare("SELECT T1.id, T2.razon, T3.marca, T3.modelo, T3.descripcion, T4.detalle, T5.nombre, T1.ordenTrabajo, T1.horometro, T1.autorizado,  T1.fechainicio,  T1.entregaequipo, T1.proximomante, T1.comentario
FROM mantepre T1
