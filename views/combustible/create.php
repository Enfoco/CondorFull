    ...
    if ( !empty($_POST)) {
     ...
     // validation errors
        ...
        if ($valid) {
            ...
            $sql = "INSERT INTO combustible (detalle) values(?)";
...
<div class="container">
                    ...
                    <div class="row">
                    <div class="row">
                        <h3>Crear Combustible</h3>
                    </div>
            
                    <form method="POST" action="">
    <div class="form-group <?php echo !empty($nameError)?'has-error':'';?>">
        <label for="inputFName">Name</label>
        <input type="text" class="form-control" required="required" id="inputname" value="<?php echo !empty($name)?$name:'';?>" name="name" placeholder="Combustible">
   </div>
   <br />
