...
<?php
    ...
    if ( !empty($_POST))
    {
        ...
        $sql = "Delete from combustible where id=?";
...
<div class="container">
    <div class="row">
        <div class="row">
            <h3>Eliminar  Combustible</h3>
        </div>
    <form method="POST" action="delete.php">
        <input type="hidden" name="id" value="<?php echo $id;?>" />
        <p class="bg-danger" style="padding: 10px;">Realmente Desea Eliminar El Combustible Seleccionado ???</p>
