    ...
    if ( !empty($_POST)) {
     ...
     // validation errors
        ...
        if ($valid) {
            ...
            $sql = "INSERT INTO empleado (nombre,apellido,telefono) values(?,?,?)";
            $stmt = $PDO->prepare($sql);
            $stmt->execute(array($name,$lastname,$phone));
            $PDO = null;
...
<div class="container">
   ...
   <br />
      ...
      <div class="form-group <?php echo !empty($lastnameError)?'has-error':'';?>">
        ...
        <input type="text" class="form-control" required="required" id="inputlastname" value="<?php echo !empty($lastname)?$lastname:'';?>" name="lastname" placeholder="Apellido">
   </div>
     <br />

     <div class="form-group <?php echo !empty($phoneError)?'has-error':'';?>">
        <label for="inputPhone">Telefono</label>
        <input type="text" class="form-control" required="required" id="inputphone" value="<?php echo !empty($phone)?$phone:'';?>" name="phone" placeholder="Telefono">
   </div>
