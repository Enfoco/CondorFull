    ...
    if ( !empty($_POST)) {
     ...
     // validation errors
        ...
        if ($valid) {
            ...
            $sql = "INSERT INTO ciudad (detalle) values(?)";
...
<div class="container">
    ...
    <div class="form-group <?php echo !empty($nameError)?'has-error':'';?>">
        <label for="inputFName">Nombre Ciudad</label><br><br>
        <input type="text" class="form-control" required="required" id="inputname" value="<?php echo !empty($name)?$name:'';?>" name="name" placeholder="Nombre Ciudad">
   <br />
