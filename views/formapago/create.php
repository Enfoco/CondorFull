    ...
    if ( !empty($_POST)) {
     ...
     // validation errors
        ...
        if ($valid) {
            ...
            $sql = "INSERT INTO formapago (detalle) values(?)";
...
<div class="container">
    ...
    <div class="form-group <?php echo !empty($nameError)?'has-error':'';?>">
        ...
        <input type="text" class="form-control" required="required" id="inputname" value="<?php echo !empty($name)?$name:'';?>" name="name" placeholder="Plan de Pago">
   </div>
    <br />
