    ...
    if ( !empty($_POST)) {
     ...
     // validation errors
        ...
        if ($valid) {
            ...
            $sql = "INSERT INTO frecuenciainterv (detalle) values(?)";
...
<div class="container">
                    ...
                    <div class="row">
                    <div class="row">
                        <h3>Crear Frecuencia de Intervenciones</h3>
                    </div>
            
                    <form method="POST" action="">
    <div class="form-group <?php echo !empty($nameError)?'has-error':'';?>">
        <label for="inputFName">Detalle</label>
        <input type="text" class="form-control" required="required" id="inputname" value="<?php echo !empty($name)?$name:'';?>" name="name" placeholder="Frecuencia de Manto">
   </div>
   <br />
